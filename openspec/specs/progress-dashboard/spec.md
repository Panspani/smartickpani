...
Define the child dashboard visual identity: adventure/pirate theme with SVG decorations, themed icons and text labels, and the primary color migration from purple (#6C5CE7) to orange (#FF6B35).
